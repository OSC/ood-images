...
RUN yum install -y centos-release-scl epel-release lsof sudo sqlite-devel
RUN yum install -y https://yum.osc.edu/ondemand/1.4/ondemand-release-web-1.4-1.el7.noarch.rpm
